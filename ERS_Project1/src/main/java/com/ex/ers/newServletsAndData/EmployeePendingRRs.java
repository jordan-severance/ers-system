...
@WebServlet("/EmployeePendingRRs")
public class EmployeePendingRRs extends HttpServlet {
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String sql = "select * from " + SCHEMA_TABLE + " where requestorid = " + requestorID + " AND pending = true";
        Connection con;
        Statement statement;
        ResultSet rs = null;
        try {
